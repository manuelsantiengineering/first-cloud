package com.msanti.authservice.config.mongodb;
...
import com.msanti.authservice.domain.MongoAccessToken;
import com.msanti.authservice.domain.MongoRefreshToken;
